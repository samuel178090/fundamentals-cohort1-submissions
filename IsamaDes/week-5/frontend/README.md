...
A modern full-stack web application frontend built with React + TypeScript + Vite, serving as the developer interface for the Pulsetrack Backend - https://github.com/IsamaDes/PulseTracker-Backend/
This project enables doctors, patients, admins, and users to authenticate, book appointment, create mealplans, view mealplans. It uses HTTP-only cookies for secure authentication and integrates with a Node.js/Express backend connected to MongoDB Atlas.

Features

🔐 Authentication using cookies (HTTP-only secure cookies)

👤 User roles: Admin, Doctorand Patient
...
| **Backend** | [PulseTracker Backend (Node.js + Express + MongoDB)](https://github.com/IsamaDes/PulseTracker-Backend/) |
...
For production
VITE_API_BASE_URL=https://pultracker-be-9plu.onrender.com/api
...
git clone https://github.com/IsamaDes/PulseTracker-Fe.git
cd DevConnect-Fe
...
CORS: backend configured for https://pulsetracker-fe origin with credentials enabled.
