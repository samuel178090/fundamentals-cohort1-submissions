...
A modern React-Vite application for health monitoring and tracking. This frontend provides an intuitive interface for managing users, activities, meals, doctor appointments, and health reports.
...
Vite provides instant HMR during development. Changes to components will reflect immediately in the browser without full page reload.
...
3. All environment variables are set in the backend `.env` file

If the backend is on a different URL, update the API base URL in your components.
